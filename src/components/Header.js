...
const Header = () => {
  return (
    ...
    style={{opacity: 0.9, backgroundColor: '#4d17d1'}}>{/*#020206*/}
      {/* logo */}
      ...
      {/* connect wallet */}
      <div className="flex items-center md:justify-center text-white" onClick={(e)=>walletConnect()}>
        <div className="bg-[#2196f3] flex items-center md:px-[16px] px-[25px] py-2 rounded-full md:h-[36px] md:min-w-[60px] cursor-pointer">
